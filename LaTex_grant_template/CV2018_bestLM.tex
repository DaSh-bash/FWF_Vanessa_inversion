...
\item[Jan. 2018 --] \textbf{Postdoctorate Researcher}, Prof. Nicholas Barton Group \\
...
\small{Note: Due to birth of my children and then official maternity leave, my teaching and conference activities were limited in 2011-2017.}
\normalsize{\item[2011 -- 2014]   \textbf{Ph.D. in Biology}\\
...
\item[2005 -- 2010] \textbf{M.S. in Biology}\\
             Department of Vertebrate Zoology,  Moscow State University, Moscow, Russia
        \begin{sublist}
...
\begin{cvlist}{Awards, Conferences, Reviewing Activities}
...
\item [2017] Reviewer for \textit{PeerJ}
 \item[2010] Current problems of ecology and conservation conference, RUDN, {Moscow}.
...
\item[2009] XXVI International  young scientist conference ``Lomonosov'', {Moscow} \\ \textbf{Best plenary presentation award}
\end{cvlist}
...
\textbf{\quad Publications of the past 5 years}
	%\small{*Maternity leave extracted}
